...
if __name__ == "__main__":
    ...
    # Define the query
    query = "What are the conditions for projects in CU XYZ need to obtain a CR approval from the MA Head? Also list Project ID, Project Name, CR ID and CR name of CRs that should be obtained a approval of MA Head."
