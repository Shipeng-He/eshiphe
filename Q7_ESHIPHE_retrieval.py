...
if __name__ == "__main__":
    ...
    # Define the query
    query = "Whether project (which project ID is the same as in the Project decision document) total actual cost is within planned cost?Total actual cost of project = actual cost of WBS 1 + … + actual cost of WBS 10 "
